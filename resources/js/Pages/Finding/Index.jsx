                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
                    ...
                    <div className="sm:rounded-lg grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 lg:gap-4">
                        {findings.data.map((finding) => {
                            return (
                                <div className="bg-base-200 card w-auto shadow-xl rounded-box space-y-2 sm:p-2">
                                    {finding.attachments.length < 1 ? (
                                        <div className="carousel rounded-t-box">
                                            <img
                                                className="carousel-item w-full h-64 sm:h-56 object-cover"
                                            ...
                                            {finding.attachments.map(
                                                (attachment) => (
                                                    <img
                                                        ...
                                                        className="carousel-item object-cover h-80 sm:h-56 w-full"
                                    ...
                                    <div className="card-body p-4 space-y-2">
                                        <h2 className="card-title font-extrabold text-lg text-opacity-65">
                                            ...
                                            >
                                                {finding.finding_status.keyword}
                                            </div>
                                        </h2>
                                        <p>{finding.description}</p>
                                        <div className="grid grid-cols-2">
                                            <div className="card-actions text-sm opacity-70">

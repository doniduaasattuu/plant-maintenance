                                    ...
                                    {findings.data.map((finding) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <td className={`w-24 ${finding.finding_status.id == 2 ? 'text-green-500' : 'text-red-500'}`} >{finding.finding_status?.keyword}</td>
                                                <td >{finding.description}</td>
                                                {/* <td>{finding.attachment_before}</td>
                                                <td>{finding.attachment_after}</td> */}
                                                <td
                                                    className="cursor-pointer"
                                                    onClick={(e) => handleAttachment(finding.attachment_before)}>
                                                ...
                                                <td>{finding.reported_by?.full_name}</td>
